...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.aggregate = nn.MultiheadAttention(embed_dim=self.seq_len, num_heads=4, batch_first=True, dropout=0.5)
    ...
    def forward(self, x, cycle_index):
        ...
        channel_information = self.aggregate(query=query_input, key=x_input, value=x_input)[0]
        x = x + channel_information.permute(0, 2, 1)
